...
/**
 * /home-v2 — the archived ORIGINAL homepage (previously served at `/`).
 * Kept as a reference baseline only; `/` now serves the V10 "Glass Loupe" hero.
 * Do not extend this page — new homepage work happens on the root route.
 */
